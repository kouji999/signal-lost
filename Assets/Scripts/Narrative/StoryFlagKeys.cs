...
{
    public static class StoryFlagKeys
    {
        public const string LifeSupportOnline = "life_support_online";
        public const string CommunicationRestored = "communication_restored";
        public const string MetEcho = "met_echo";
        public const string FoundFirstLog = "found_first_log";
        public const string PodExited = "pod_exited";
        public const string DoorAnomaly = "door_anomaly";
